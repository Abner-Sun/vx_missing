...
/* 
 * Copyright (c) 1984-1997, 2006, 2008 Wind River Systems, Inc. 
 *
...
--------------------
02s,08jul08,gls  added warning about inclusion in semLibInline.h
02r,21dec06,aeg  added _WRS_FUNC_NORETURN attribute to _sigCtxLoad
02q,06mar06,gls  added queuedPend to sigpend
02p,07feb06,gls  added SIGFAULT_POSIX_SIGNUM and SIGFAULT_VXWORKS_SIGNUM
                 added parameter to sigInit()
02o,31jan06,pes  Define SIGFAULTVEC macro.
02n,13jan06,gls  added sigFfsMsb function prototype
                 removed K&R style function prototypes
02m,19may97,jpd  made RESTART available from ASMLANGUAGE.
...
extern void 	_sigCtxSetup       (REG_SET *regs, void *pStackBase, 
				    void (*taskEntry)(), int *args);

extern int	sigInit 	   (BOOL posixMode);
